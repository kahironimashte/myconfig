...
* Org Mode Settings
** Neuestes Org-Paket aus MELPA verwenden
...
#+END_SRC
* Sonstiges
** TODO Template Expansion - Abkürzugnen für häufige Ausdrücke
- [ ] Dieser Code muss für *Org ab 9.2* angepasst werden zu org-tempo-keyword-alist. Außerdem braucht man (require 'org-tempo)
#+BEGIN_SRC emacs-lisp
;; Code für emacs-lisp
