...
;;	      (org-agenda-sorting-strategy '(todo-state-down)))
	   ...
	   (tags "TODO=\"PLAN\"+AUTOR<>\"\""
        ...
        ("dg-" "Nur Deadlines" agenda "Diesen Monat" (
...
#+begin_src emacs-lisp :results silent
  ...
  ;;    (org-caldav-sync)  ;; deaktiviert, weil es bei Fehlern Probleme mit dem Beenden gibt.
      (save-some-buffers))
...
;;     :select-tags ("work") 
    ...
    (setq org-caldav-skip-conditions '('todo 'done))
    ...
    ;; Add the close emacs hook ;; deaktiviert wegen Problemen wenn kein Internet verfügbar
