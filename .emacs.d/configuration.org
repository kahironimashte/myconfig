...
(setq org-agenda-custom-commands
	...
	("ga" "Autorentexte" tags "Autor|AUTOR<>\"\""
	     ((org-agenda-sorting-strategy '(todo-state-down)
	     )))
	("gb" "Autorentexte Properties" 
	   (;;(agenda "")
...
;;	      (org-agenda-sorting-strategy '(todo-state-down)))
	...
	("n" "Nächste Schritte" todo "NEXT|WAITING"
	     ((org-agenda-span 1)
	      (org-show-context-detail 'minimal)))
	("N" "Nächste Schritte" agenda ""
	     ((org-agenda-span 1)
;	      (org-agenda-category-filter-preset '("+xa"))
	...
	("h" "Arbeitsaufgaben für heute" todo "")
	))
