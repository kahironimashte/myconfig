...
(defun kahiro-kp-0 (&optional arg)
  (interactive "P")
  (org-agenda arg "dt" nil)) ;; Arbeits-Tasks heute

 (global-set-key (kbd "<kp-1>") 'kahiro-kp-1)
(defun kahiro-kp-1 (&optional arg)
  (interactive "P")
  (org-agenda arg "da" nil)) ;; Arbeits-Tasks heute

 (global-set-key (kbd "<kp-2>") 'kahiro-kp-2) 
(defun kahiro-kp-2 (&optional arg)
  (interactive "P")
  (org-agenda arg "db" nil)) ;; BR-Tasks heute

 (global-set-key (kbd "<kp-3>") 'kahiro-kp-3) 
(defun kahiro-kp-3 (&optional arg)
  (interactive "P")
  (org-agenda arg "dh" nil)) ;; Home-Tasks heute
...
(defun kahiro-kp-4 (&optional arg)
 ...
 (global-set-key (kbd "<kp-5>") 'kahiro-kp-5) 
(defun kahiro-kp-5 (&optional arg)
  (interactive "P")
...
(global-set-key (kbd "<kp-decimal>") 'kahiro-agenda-for-tasks-in-subtree) 
(defun kahiro-agenda-for-tasks-in-subtree (&optional arg)
  (interactive "P")
  (org-agenda arg "gh" 'subtree))
   ;; narrowing hier nur als Beispiel:
   ;; statt t kann man auch die Optionen
   ;; 'buffer | 'subtree | 'region verwenden.
  ...
  (transient-define-prefix my/org-remark-prefix nil
    ...
    [["Highlighter"
     ...
     ["Navigate annotations"
      ...
      ("v" "go to next annotation" org-remark-view)      
      ("o" "go to next annotation" org-remark-open)]
     ["Edit annotations"
...
#+begin_src emacs-lisp :results output silent
(setq my/org-agenda-custom-commands-d
      '(
	("d" . "Tägliche Übersichen und Filter")
        ("dt" occur-tree (concat "^" org-outline-regexp " *" "\\(TODO\\|NEXT\\)")
	 ((org-show-context-detail 'minimal)))
        ("da" "Wichtigste Arbeits-Tasks heute" agenda ""
	 ((org-agenda-span 1)
	  (org-agenda-overriding-header "Heute - Aktuelle Ausgabe, Kalender, Inbox")
	  (org-agenda-category-filter-preset '("-habit" "-htasks" "-br"))
	  (org-agenda-sorting-strategy '(todo-state-down priority-down deadline-down scheduled-down ))
	  (org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done))
	  ))
        ("db" "Wichtigste BR-Tasks heute"
	 ((todo "NEXT" ((org-agenda-overriding-header "Als nächstes für den BR erledigen")) )
	  (todo "TODO" ((org-agenda-overriding-header "weitere BR-Aufgaben:")
		    (org-agenda-max-entries 5)
		      )))
	 ((org-agenda-category-filter-preset '("-habit" "-htasks" "-atasks"))
	  (org-agenda-sorting-strategy '(todo-state-down priority-down deadline-down scheduled-down ))
	  (org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done))
	  ))
        ("dh" "Wichtigste Home-Tasks heute" agenda ""
	 ((org-agenda-span 1)
	  (org-agenda-overriding-header "Was heute ansteht:")
	  (org-agenda-category-filter-preset '("-habit" "-br" "-atasks"))
	  (org-agenda-sorting-strategy '(todo-state-down priority-down deadline-down scheduled-down ))
	  (org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done))
	  ))
...
**** g/h - eigene Agendas
#+begin_src emacs-lisp :results output silent
(setq my/org-agenda-custom-commands-g
      '(
	("g" . "My Custom Agendas")
...
(setq my/org-agenda-custom-commands-h
      '(
...
**** k - zu klären
     #+begin_src emacs-lisp :results output silent
(setq my/org-agenda-custom-commands-k
      '(
	("k" "zu klären"
	 ((tags-todo "klären"
...
**** n - nächste Schritte
#+begin_src emacs-lisp :results output silent
(setq my/org-agenda-custom-commands-n
      '(
	("n" "Nächste Schritt"
...
#+begin_src emacs-lisp :results output silent
(setq my/org-agenda-custom-commands-o
      '(
...
**** p - Planung (Arbeit)
#+begin_src emacs-lisp :results output silent
(setq my/org-agenda-custom-commands-p
      '(
...
**** TODO COMMENT Erläuterungen
 ...
 (setq org-agenda-custom-commands
  ...
  #+END_SRC
**** Merge all agenda-custom-comand code blocks
 #+BEGIN_SRC emacs-lisp :results output silent
;; AGENDA MODES
;;--------------
(setq org-agenda-custom-commands
      (cl-concatenate 'list
		        ;; boundp checks if value part of list is set.
		      (if (boundp 'my/org-agenda-custom-commands-p) my/org-agenda-custom-commands-p)
		      (if (boundp 'my/org-agenda-custom-commands-o) my/org-agenda-custom-commands-o)
		      (if (boundp 'my/org-agenda-custom-commands-n) my/org-agenda-custom-commands-n)
		      (if (boundp 'my/org-agenda-custom-commands-k) my/org-agenda-custom-commands-k)
		      (if (boundp 'my/org-agenda-custom-commands-g) my/org-agenda-custom-commands-g)
		      (if (boundp 'my/org-agenda-custom-commands-h) my/org-agenda-custom-commands-h)
		      (if (boundp 'my/org-agenda-custom-commands-d) my/org-agenda-custom-commands-d)
		      ))
#+end_src
...
Options: 
 ...
 (setq org-todo-keywords
   '(
     ...
     (sequence "WAITING(w!/!)" "PLAN(p)" "DECIS(e!/@)" "TODO(t)" "NEXT(n)" "|" "DONE(d)")             ;; Actionlist
    ))
 #+end_src
