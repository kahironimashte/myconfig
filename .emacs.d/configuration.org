...
(when (string-equal system-type "windows-nt")
    (use-package org-caldav
      :init
      (setq org-caldav-url "https://cloud3.linuxfabrik.io/remote.php/dav/calendars/cloud@hailmail.net")
...
** Tag-Vererbung
#+begin_src emacs-lisp :results output silent
(setq org-tags-exclude-from-inheritance '("Autor" "Fokus" "TB" "leer" "kur" "gut" "2021" "Reportage" "Portrait" "ContentLeitstand" "CL"))
