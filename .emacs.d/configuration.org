...
** COMMENT makros
  ...
  (fset 'macro-statusnow
   ...
   - [2024-06-23 So] deaktiviert, da kein Einsatz für Tagebuch mehr.
...
** org-clock-convenience :clocking:orga:
 ...
 - [2024-06-23 So] F-Keys deaktiviert weil selten benutzt
#+begin_src emacs-lisp :results output silent
...
** Tag-Vererbung
#+begin_src emacs-lisp :results output silent
(setq org-tags-exclude-from-inheritance '("BR" "KBR" "Präsenz" "Virtuell" "ohnemich" "Autor" "Fokus" "TB" "leer" "kur" "gut" "2022" "Reportage" "Portrait" "ContentLeitstand" "CL"))
...
#+begin_src emacs-lisp :results output silent
 ...
 (global-set-key (kbd "<f6>") '(lambda () (interactive)(org-capture nil "ra")))
 (global-set-key (kbd "<f7>") '(lambda () (interactive)(org-capture nil "rz")))
